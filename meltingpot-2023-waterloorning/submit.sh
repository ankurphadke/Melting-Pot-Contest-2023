...
check_cli_install() {
  ...
  git remote add aicrowd https://oauth2:$OAUTH@gitlab.aicrowd.com/$USERNAME/meltingpot-2023-starter-kit 2> /dev/null
  git config lfs.https://oauth2:$OAUTH@gitlab.aicrowd.com/$USERNAME/meltingpot-2023-starter-kit/info/lfs.locksverify true
  git config lfs.https://gitlab.aicrowd.com/$USERNAME/meltingpot-2023-starter-kit/info/lfs.locksverify true
  retval=$?
  if [ $retval -ne 0 ]; then
