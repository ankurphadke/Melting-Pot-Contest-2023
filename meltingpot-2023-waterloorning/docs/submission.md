...
```bash
cd meltingpot-2023-starter-kit

# Add AIcrowd git remote endpoint
git remote add aicrowd git@gitlab.aicrowd.com:<YOUR_AICROWD_USER_NAME>/meltingpot-2023-starter-kit.git 
...
`https://gitlab.aicrowd.com/<YOUR_AICROWD_USER_NAME>/meltingpot-2023-starter-kit/issues`
